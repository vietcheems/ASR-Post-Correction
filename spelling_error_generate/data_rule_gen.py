...
import codecs
from add_noise_rule import add_noise_sentence
import json
...
RAITO_EACH_ERROR = [0 for i in range(8)]
RAITO_EACH_ERROR[0]= 0.1
RAITO_EACH_ERROR[1]= 0.1
RAITO_EACH_ERROR[2]= 0.1
RAITO_EACH_ERROR[3]= 0.1
RAITO_EACH_ERROR[4]= 0.1
RAITO_EACH_ERROR[5]= 0.1
RAITO_EACH_ERROR[6]= 0.1
RAITO_EACH_ERROR[7]= 0.1
...
def split_sentences(sentences,max_length = 50):
    ...
    for i,sentence in enumerate(sentences):
        if len(sentence) <= 80:
            ...
            split_sents.append(sentence[:80])
            count+=1
    print(count)
    return split_sents
...
if __name__ == "__main__":
    data_gen('char_5_error/split_sent.pickle','final_dataset/word_train_2_error.json','final_dataset/word_valid_2_error.json','test_rule.json')
